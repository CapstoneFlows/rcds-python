...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.NorthLabel_2 = QtGui.QLabel(self.MapTab)
        self.NorthLabel_2.setAlignment(QtCore.Qt.AlignCenter)
        self.NorthLabel_2.setObjectName(_fromUtf8("NorthLabel_2"))
        self.gridLayout_3.addWidget(self.NorthLabel_2, 1, 1, 1, 1)
        ...
        self.WestLabel_2 = QtGui.QLabel(self.MapTab)
        self.WestLabel_2.setAlignment(QtCore.Qt.AlignCenter)
        self.WestLabel_2.setObjectName(_fromUtf8("WestLabel_2"))
        self.gridLayout_3.addWidget(self.WestLabel_2, 4, 1, 1, 1)
        ...
        self.time_label = QtGui.QLabel(self.MapTab)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.time_label.setFont(font)
        self.time_label.setObjectName(_fromUtf8("time_label"))
        self.horizontalLayout_8.addWidget(self.time_label, 0, QtCore.Qt.AlignHCenter)
        ...
        self.verticalLayout_10.addWidget(self.straight_label, 0, QtCore.Qt.AlignHCenter)
        self.right_label = QtGui.QLabel(self.MapTab)
        self.right_label.setObjectName(_fromUtf8("right_label"))
        self.verticalLayout_10.addWidget(self.right_label, 0, QtCore.Qt.AlignHCenter)
        self.left_label = QtGui.QLabel(self.MapTab)
        self.left_label.setObjectName(_fromUtf8("left_label"))
        self.verticalLayout_10.addWidget(self.left_label, 0, QtCore.Qt.AlignHCenter)
        self.unknown_label = QtGui.QLabel(self.MapTab)
        self.unknown_label.setObjectName(_fromUtf8("unknown_label"))
        self.verticalLayout_10.addWidget(self.unknown_label, 0, QtCore.Qt.AlignHCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.EastLabel.setText(_translate("MainWindow", "<html><head/><body><p><img src=\":/intersection/arrowNone.jpg\"/></p></body></html>", None))
        self.NorthLabel_2.setText(_translate("MainWindow", "<html><head/><body><p><img src=\":/intersection/arrowNone.jpg\"/></p></body></html>", None))
        self.PlayPauseButton.setText(_translate("MainWindow", "Play", None))
        self.WestLabel_2.setText(_translate("MainWindow", "<html><head/><body><p><img src=\":/intersection/arrowNone.jpg\"/></p></body></html>", None))
        self.SouthLabel.setText(_translate("MainWindow", "<html><head/><body><p><img src=\":/intersection/arrowNone.jpg\"/></p></body></html>", None))
        self.time_label.setText(_translate("MainWindow", "00:00:00", None))
        ...
        self.straight_label.setText(_translate("MainWindow", "Straight: 0", None))
        self.right_label.setText(_translate("MainWindow", "Right: 0", None))
        self.left_label.setText(_translate("MainWindow", "Left: 0", None))
        self.unknown_label.setText(_translate("MainWindow", "?: 0", None))
